...
import { Home, BookCopy, BarChart3, Files, Users2, Search, User, ChevronLeft, ChevronRight } from 'lucide-react';
...
const Navbar = () => {
  ...
  return (
    <div className={`max-h-screen sticky top-0 overflow-y-auto flex flex-col justify-start pt-4 items-center ${isCollapsed ? 'min-w-12' : 'p-4 w-[192px] min-w-[142px]' } bg-[#c0dce9] transition-width duration-300`}>
